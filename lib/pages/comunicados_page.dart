...
class ComunicadosPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appBarWidget(titulo: 'COMUNICADOS', color: colores.gris, texto: Colors.green, logoClaro: true),
      body: SafeArea(
        child: Container(
          width: size.width,
          height: size.height,
          ...
          children: [
            ClipRRect(
              ...
              child: Container(
                ...
                child: Image(image: NetworkImage(this.evento["img"]), fit: BoxFit.cover,),
              ),
            ),
            SizedBox(width: 20,),
            Column(
              ...
              children: [
                Text(this.evento["title"], style: TextStyle( fontWeight: FontWeight.bold ),),
                SizedBox(height: 5,),
