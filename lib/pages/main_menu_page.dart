  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Image( image: AssetImage('assets/icons/$icono'), width: size.width*0.12,),
          SizedBox(height: 10,),
          Text( this.titulo, style: TextStyle( fontSize: 10, fontWeight: FontWeight.bold, color: colores.verde ))
        ],
      ),
    );
  }
