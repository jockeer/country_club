                      ...
                      child: Column(
                        children: [
                          ...
                          TabBar(
                            ...
                            tabs: [
                              Tab(child: Text('Eventos', style: TextStyle(fontWeight: FontWeight.bold),),),
                              Tab(child: Text('Calendario', style: TextStyle(fontWeight: FontWeight.bold),),),
                            ],
                          ),
                          Expanded(
                            child: TabBarView(
    ...
    return FutureBuilder(
      ...
      builder: (context, AsyncSnapshot snapshot){
        if (snapshot.hasData) {
          ...
          return _Eventos(eventos: snapshot.data,);
        }
          ...
          children: [
            ClipRRect(
              ...
              child: Container(
                ...
                child: Image(image: NetworkImage(this.evento["url_jpg"]), fit: BoxFit.cover,),
              ),
            ),
            SizedBox(width: 20,),
            Column(
              ...
              Expanded(
                child: Container(
                  child: (provider.fechaElegida==""||provider.fechaElegida==null)
                    ? Container()
                    : FutureBuilder(
                      future: eventosService.obtenerEventosPorFecha(provider.fechaElegida),
                      builder: ( _ , AsyncSnapshot snapshot ){
                        if (snapshot.hasData) {
                          if (snapshot.data.length==0) {
                            return Center(child: Text('Sin Eventos'),);
                          } 
                          return ListView.builder(
