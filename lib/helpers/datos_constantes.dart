...
class DatosConstantes {
  String dominio = "https://laspalmascountryclub.com.bo";
}
...
class EstilosApp {
  InputDecoration inputDecoration(
      {@required String hintText, double padingTop = 0.0}) {
  ...
  InputDecoration inputDecorationinicio(
      {@required String hintText, double padingTop = 0.0}) {
    return InputDecoration(
        contentPadding:
            EdgeInsets.symmetric(vertical: padingTop, horizontal: 0.0),
        hintText: hintText,
        filled: true,
        fillColor: Colors.white);
  }

  InputDecoration inputTarjetaDecoration(
  ...
  Padding inputLabel(
      {@required String label, bool obligatorio = false, bool padding = true}) {
    return Padding(
        padding: (padding)
  ...
  Padding buttonChild({@required String texto, double fuente = 18.0}) {
    return Padding(
      ...
      child: Text(
        texto,
        style: TextStyle(fontSize: fuente, fontWeight: FontWeight.bold),
      ),
    );
  }
